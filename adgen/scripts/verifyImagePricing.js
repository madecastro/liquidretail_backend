...
'use strict';
/**
 * PORTED from liquidretail_backend/scripts/verifyImagePricing.js
 * (pre-2026-08-24 snapshot) into liquidretail_adgen. Path adjustment only
 * (../services/atlasImageService -> ../src/services/atlasImageService);
 * every assertion below is unchanged from the backend original.
 *
...
const { buildPriceMap } = require('../src/services/atlasImageService');
