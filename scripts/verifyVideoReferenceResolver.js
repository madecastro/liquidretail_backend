#!/usr/bin/env node
// Offline pins for services/videoReferenceResolver.js — the cache-first
// helper every video-model ref path (backend Atlas Omni, backend Veo 3.1
// preview, adgen direct-Gemini) should call to resolve a Media doc + target
